...
export const CLS_SOCIAL_ICON =
  "fill-gray-300 hover:fill-blue-400 transition-ani transition-color border border-gray-200 rounded-full flex flex-row items-center justify-center w-10 h-10"
